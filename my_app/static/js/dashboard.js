            ...
            success: function(url){
              if(url.authenticated == 'True')
              {
                   if(url.response == 'ON'){
                    ...
                    $('.warningMessage').html('<div class="alert alert-danger">'+
                    'You are not logged in!  <button type="button" class="close" data-dismiss="alert" aria-label="Close">'+
